    ...
    public partial class Login : MetroSetForm
    {
        ...
        private void Login_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                txtFaceName.Visible = false;
                btnEgit.Visible = false;
                ...
                capture.ImageGrabbed += (a, b) =>
                {
                    ...
                    foreach (MCvAvgComp yuz in Yuzler[0])
                    {
                        ...
                        string isim = train.Recognise(sadeyuz);
                        connection = new MySqlConnection(myConnectionString);
                        connection.Open();
                        ...
                        while (reader.Read())
                        {
                            if (isim == reader["username"].ToString())
                            {
                                label1.Text = "Yüzünüz algılandı uygulamaya giriş yapabilirsiniz";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            music.Closed += (s, args) => this.Close();
            music.Show();
        }
    }
}
